...
#define E120_SD_INTENSITY                                 0x0001  // Intensity
#define E120_SD_INTENSITY_MASTER                          0x0002  // Intensity Master
// Movement Functions (0x01xx)
#define E120_SD_PAN                                       0x0101  // Pan
#define E120_SD_TILT                                      0x0102  // Tilt
// Color Functions (0x02xx)
#define E120_SD_COLOR_WHEEL                               0x0201  // Color Wheel
#define E120_SD_COLOR_SUB_CYAN                            0x0202  // Subtractive Color Mixer – Cyan/Blue
#define E120_SD_COLOR_SUB_YELLOW                          0x0203  // Subtractive Color Mixer – Yellow/Amber
#define E120_SD_COLOR_SUB_MAGENTA                         0x0204  // Subtractive Color Mixer - Magenta
...
#define E120_SD_COLOR_SCROLL                              0x0209  // Color Scroll
#define E120_SD_COLOR_SEMAPHORE                           0x0210  // Color Semaphore
// Image Functions (0x03xx)
#define E120_SD_STATIC_GOBO_WHEEL                         0x0301  // Static gobo wheel
#define E120_SD_ROTO_GOBO_WHEEL                           0x0302  // Rotating gobo wheel
#define E120_SD_PRISM_WHEEL                               0x0303  // Prism wheel
#define E120_SD_EFFECTS_WHEEL                             0x0304  // Effects wheel
// Beam Functions (0x04xx)
#define E120_SD_BEAM_SIZE_IRIS                            0x0401  // Beam size iris
#define E120_SD_EDGE                                      0x0402  // Edge/Lens focus
#define E120_SD_FROST                                     0x0403  // Frost/Diffusion
#define E120_SD_STROBE                                    0x0404  // Strobe/Shutter
#define E120_SD_ZOOM                                      0x0405  // Zoom lens
#define E120_SD_FRAMING_SHUTTER                           0x0406  // Framing shutter
#define E120_SD_SHUTTER_ROTATE                            0x0407  // Framing shutter rotation
#define E120_SD_DOUSER                                    0x0408  // Douser
#define E120_SD_BARN_DOOR                                 0x0409  // Barn Door
// Control Fuctions (0x05xx)
#define E120_SD_LAMP_CONTROL                              0x0501  // Lamp control functions
#define E120_SD_FIXTURE_CONTROL                           0x0502  // Fixture control channel
#define E120_SD_FIXTURE_SPEED                             0x0503  // Overall speed setting applied to multiple or all parameters
#define E120_SD_MACRO                                     0x0504  // Macro control
// Other
#define E120_SD_UNDEFINED                                 0xFFFF  // No definition
